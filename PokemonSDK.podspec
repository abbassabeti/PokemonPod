...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/39451059/PokemonSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '39451059' => 'abbassabetiii@gmail.com' }
  s.source           = { :git => 'https://github.com/39451059/PokemonSDK.git', :tag => s.version.to_s }
